      ...
      <section class="bg-white rounded-3xl md:rounded-[2rem] shadow-xl p-5 md:p-12 border border-slate-100">
        ...
        <div v-else 
          ...
          <div
            ...
            class="group flex items-center p-3 md:p-4 rounded-xl md:rounded-2xl border-2 border-slate-100 bg-slate-50 hover:bg-white hover:border-indigo-300 hover:shadow-md transition-all cursor-pointer"
          >
            <span class="w-8 h-8 md:w-12 md:h-12 shrink-0 flex items-center justify-center rounded-lg md:rounded-xl bg-white text-indigo-600 font-black text-xs md:text-lg group-hover:bg-indigo-600 group-hover:text-white transition-colors shadow-sm border border-slate-100">
              {{ index + 1 + popularPage * popularPageSize }}
            </span>
            <span class="ml-3 md:ml-5 text-slate-700 font-bold text-xs md:text-lg truncate group-hover:text-indigo-700 transition-colors">
              {{ board.topic }}
            </span>
          </div>
        </div>
